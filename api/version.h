...
constexpr int BUILD_NUMBER = 10;
constexpr const char* GIT_COMMIT = "3b7e8d5";
constexpr const char* GIT_BRANCH = "master";
constexpr const char* BUILD_DATE = "2025-12-07";
constexpr const char* BUILD_TIME = "21:43:13";
