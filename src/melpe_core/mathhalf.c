...
Shortword melp_round(Longword L_var1)
{
    Longword    L_Prod;
    Shortword   var2;
...
Shortword shr(Shortword var1, Shortword var2)
{
    ...
    if (var2 == 0 || var1 == 0)
        ...
        if (var2 <= -15){
            swOut = (Shortword) ((var1 > 0) ? SWord_MAX : SWord_MIN);
                                                                  /* saturate */
            inc_saturation();
        } else
...
Longword L_mult(Shortword var1, Shortword var2)
{
    ...
    if (var1 == SWord_MIN && var2 == SWord_MIN){                        /* overflow */
        inc_saturation();
        L_product = LW_MAX;
    } else {
...
Shortword msu_r(Longword L_var3, Shortword var1, Shortword var2)
{
    ...
    swOut = melp_round(L_sub(L_var3, L_mult(var1, var2)));
    return (swOut);
}
