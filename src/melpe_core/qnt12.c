                      ...
                      Shortword dim, Boolean flag)
{
    ...
    *==================================================================*/
    ...
    for (s1 = 0; s1 < tos; s1++){
        ...
        fill(dMin, SWord_MAX, LSP_VQ_CAND);
        max_dMin = SWord_MAX;
                ...
                const Shortword x[], Shortword target[], Shortword max_dMin)
{
    ...
    if (melp_round(distortion) >= max_dMin)      /* if this situation takes place, */
        return(SWord_MAX);                    /* distortion will exceed max_dMin */
                                                         /* and we can leave. */
