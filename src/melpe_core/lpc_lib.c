...
Shortword lpc_pred2lsp(Shortword lpc[], Shortword lsf[], Shortword order)
{
    ...
    for (i = 0; i <= p2; i++){
        p_cof[i] = melp_round(L_p_cof[i]);                         /* p_cof in Q10 */
        q_cof[i] = melp_round(L_q_cof[i]);                         /* q_cof in Q10 */
    }
