...
Available tests:
ΓÇó Standard: Run through all channel conditions
ΓÇó Progressive: Find performance limits (SNR, freq offset, multipath)
ΓÇó Reference Samples: Test MS-DMT compatibility (14 reference samples)
            ...
            <div class="melpe-container">
                ...
                <div class="melpe-controls">
                    ...
                    <div class="field">
                        ...
                        <button class="btn-run-vocoder" id="btn-run-melpe" onclick="runMelpeVocoder()">
                            ≡ƒöä Run Loopback Test
                        </button>
                    </div>
                </div>
                
                <div class="record-section">
                    <h4>≡ƒÄÖ∩╕Å Record Your Own Audio</h4>
                ...
                <div class="audio-panel">
                    <div class="audio-card">
                        <h3>≡ƒôÑ Input Audio (Original)</h3>
                    ...
                    <div class="audio-card">
                        <h3>≡ƒôñ Output Audio (Processed)</h3>
                ...
                <div class="melpe-info">
                    <h4>Γä╣∩╕Å About MELPe Vocoder</h4>
        ...
        <div id="tab-interop" class="tab-content">
            <div class="controls">
                <!-- Sub-tab Navigation -->
                <div class="sub-tabs">
                    <button class="sub-tab active" onclick="showSubTab('setup')">≡ƒöº Connection Setup</button>
                    <button class="sub-tab" onclick="showSubTab('single')">≡ƒº¬ Single Tests</button>
                    <button class="sub-tab" onclick="showSubTab('matrix')">≡ƒôè Matrix Test</button>
                    <button class="sub-tab" onclick="showSubTab('reference')">≡ƒôé Reference Tests</button>
                </div>
                
                <!-- Sub-tab: Connection Setup -->
                <div id="subtab-setup" class="sub-tab-content active">
                <div class="interop-section">
                    <h3>≡ƒÜÇ PhoenixNest Server</h3>
                ...
                <div class="test-direction">
                    <h4>≡ƒôñ Test 1: MS-DMT TX ΓåÆ PhoenixNest RX</h4>
                    ...
                    <ul class="test-steps" id="test1-steps">
                        <li><span class="step-icon step-pending">Γùï</span> Set MS-DMT data rate</li>
                        <li><span class="step-icon step-pending">Γùï</span> Enable TX recording</li>
                        <li><span class="step-icon step-pending">Γùï</span> Send test message</li>
                        <li><span class="step-icon step-pending">Γùï</span> Trigger SENDBUFFER</li>
                        <li><span class="step-icon step-pending">Γùï</span> Wait for TX:IDLE</li>
                        <li><span class="step-icon step-pending">Γùï</span> Find TX PCM file</li>
                        <li><span class="step-icon step-pending">Γùï</span> Connect to PhoenixNest server</li>
                        <li><span class="step-icon step-pending">Γùï</span> Inject PCM into PhoenixNest RX</li>
                        <li><span class="step-icon step-pending">Γùï</span> Wait for DCD</li>
                        <li><span class="step-icon step-pending">Γùï</span> Read decoded data</li>
                        <li><span class="step-icon step-pending">Γùï</span> Wait for NO DCD</li>
                        <li><span class="step-icon step-pending">Γùï</span> Compare output</li>
                    </ul>
                ...
                <div class="test-direction">
                    <h4>≡ƒôÑ Test 2: PhoenixNest TX ΓåÆ MS-DMT RX</h4>
                    <p style="color:#888; font-size:12px; margin-bottom:15px;">
                    ...
                    <ul class="test-steps" id="test2-steps">
                        <li><span class="step-icon step-pending">Γùï</span> Connect to PhoenixNest server</li>
                        <li><span class="step-icon step-pending">Γùï</span> Set PhoenixNest data rate</li>
                        <li><span class="step-icon step-pending">Γùï</span> Enable TX recording</li>
                        <li><span class="step-icon step-pending">Γùï</span> Send test message</li>
                        <li><span class="step-icon step-pending">Γùï</span> Trigger SENDBUFFER</li>
                        <li><span class="step-icon step-pending">Γùï</span> Wait for TX:IDLE</li>
                        <li><span class="step-icon step-pending">Γùï</span> Find TX PCM file</li>
                        <li><span class="step-icon step-pending">Γùï</span> Inject PCM into MS-DMT RX</li>
                        <li><span class="step-icon step-pending">Γùï</span> Wait for STATUS:RX:&lt;mode&gt;</li>
                        <li><span class="step-icon step-pending">Γùï</span> Read decoded data</li>
                        <li><span class="step-icon step-pending">Γùï</span> Wait for NO DCD</li>
                        <li><span class="step-icon step-pending">Γùï</span> Compare output</li>
                    </ul>
                ...
                <div class="matrix-container">
                    ...
                    <table class="matrix-table">
                        ...
                        <tbody id="matrix-body">
                            <tr><td>75S</td><td class="matrix-cell matrix-pending" id="m-75S-1">Γùï</td><td class="matrix-cell matrix-pending" id="m-75S-2">Γùï</td></tr>
                            <tr><td>75L</td><td class="matrix-cell matrix-pending" id="m-75L-1">Γùï</td><td class="matrix-cell matrix-pending" id="m-75L-2">Γùï</td></tr>
                            <tr><td>150S</td><td class="matrix-cell matrix-pending" id="m-150S-1">Γùï</td><td class="matrix-cell matrix-pending" id="m-150S-2">Γùï</td></tr>
                            <tr><td>150L</td><td class="matrix-cell matrix-pending" id="m-150L-1">Γùï</td><td class="matrix-cell matrix-pending" id="m-150L-2">Γùï</td></tr>
                            <tr><td>300S</td><td class="matrix-cell matrix-pending" id="m-300S-1">Γùï</td><td class="matrix-cell matrix-pending" id="m-300S-2">Γùï</td></tr>
                            <tr><td>300L</td><td class="matrix-cell matrix-pending" id="m-300L-1">Γùï</td><td class="matrix-cell matrix-pending" id="m-300L-2">Γùï</td></tr>
                            <tr><td>600S</td><td class="matrix-cell matrix-pending" id="m-600S-1">Γùï</td><td class="matrix-cell matrix-pending" id="m-600S-2">Γùï</td></tr>
                            <tr><td>600L</td><td class="matrix-cell matrix-pending" id="m-600L-1">Γùï</td><td class="matrix-cell matrix-pending" id="m-600L-2">Γùï</td></tr>
                            <tr><td>1200S</td><td class="matrix-cell matrix-pending" id="m-1200S-1">Γùï</td><td class="matrix-cell matrix-pending" id="m-1200S-2">Γùï</td></tr>
                            <tr><td>1200L</td><td class="matrix-cell matrix-pending" id="m-1200L-1">Γùï</td><td class="matrix-cell matrix-pending" id="m-1200L-2">Γùï</td></tr>
                            <tr><td>2400S</td><td class="matrix-cell matrix-pending" id="m-2400S-1">Γùï</td><td class="matrix-cell matrix-pending" id="m-2400S-2">Γùï</td></tr>
                            <tr><td>2400L</td><td class="matrix-cell matrix-pending" id="m-2400L-1">Γùï</td><td class="matrix-cell matrix-pending" id="m-2400L-2">Γùï</td></tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="matrix-container">
                    <h3 style="color:#00d4ff; margin:0 0 15px 0;">≡ƒôé MS-DMT Reference PCM Decode Test</h3>
                    <p style="color:#888; font-size:12px; margin-bottom:15px;">
                    ...
                    <table class="matrix-table">
                        ...
                        <tbody id="ref-pcm-body">
                            <tr><td>75S</td><td class="matrix-cell matrix-pending" id="ref-75S">Γùï</td><td id="ref-75S-exp">-</td><td id="ref-75S-dec">-</td></tr>
                            <tr><td>75L</td><td class="matrix-cell matrix-pending" id="ref-75L">Γùï</td><td id="ref-75L-exp">-</td><td id="ref-75L-dec">-</td></tr>
                            <tr><td>150S</td><td class="matrix-cell matrix-pending" id="ref-150S">Γùï</td><td id="ref-150S-exp">-</td><td id="ref-150S-dec">-</td></tr>
                            <tr><td>150L</td><td class="matrix-cell matrix-pending" id="ref-150L">Γùï</td><td id="ref-150L-exp">-</td><td id="ref-150L-dec">-</td></tr>
                            <tr><td>300S</td><td class="matrix-cell matrix-pending" id="ref-300S">Γùï</td><td id="ref-300S-exp">-</td><td id="ref-300S-dec">-</td></tr>
                            <tr><td>300L</td><td class="matrix-cell matrix-pending" id="ref-300L">Γùï</td><td id="ref-300L-exp">-</td><td id="ref-300L-dec">-</td></tr>
                            <tr><td>600S</td><td class="matrix-cell matrix-pending" id="ref-600S">Γùï</td><td id="ref-600S-exp">-</td><td id="ref-600S-dec">-</td></tr>
                            <tr><td>600L</td><td class="matrix-cell matrix-pending" id="ref-600L">Γùï</td><td id="ref-600L-exp">-</td><td id="ref-600L-dec">-</td></tr>
                            <tr><td>1200S</td><td class="matrix-cell matrix-pending" id="ref-1200S">Γùï</td><td id="ref-1200S-exp">-</td><td id="ref-1200S-dec">-</td></tr>
                            <tr><td>1200L</td><td class="matrix-cell matrix-pending" id="ref-1200L">Γùï</td><td id="ref-1200L-exp">-</td><td id="ref-1200L-dec">-</td></tr>
                            <tr><td>2400S</td><td class="matrix-cell matrix-pending" id="ref-2400S">Γùï</td><td id="ref-2400S-exp">-</td><td id="ref-2400S-dec">-</td></tr>
                            <tr><td>2400L</td><td class="matrix-cell matrix-pending" id="ref-2400L">Γùï</td><td id="ref-2400L-exp">-</td><td id="ref-2400L-dec">-</td></tr>
                        </tbody>
                    </table>
                </div>
                
                <div class="matrix-container" style="margin-top:20px;">
                    <h3 style="color:#00d4ff; margin:0 0 15px 0;">≡ƒÜÇ PhoenixNest Reference PCM Decode Test</h3>
                    <p style="color:#888; font-size:12px; margin-bottom:15px;">
                    ...
                    <div class="test-controls" style="margin-bottom:15px;">
                        <button class="btn-run" id="btn-pn-ref-pcm" onclick="runPnRefPcmTest()">
                            Γû╢ Test All Reference PCMs on PhoenixNest
                        </button>
                    ...
                    <table class="matrix-table">
                        ...
                        <tbody id="pn-ref-pcm-body">
                            <tr><td>75S</td><td class="matrix-cell matrix-pending" id="pn-ref-75S">Γùï</td><td id="pn-ref-75S-exp">-</td><td id="pn-ref-75S-dec">-</td></tr>
                            <tr><td>75L</td><td class="matrix-cell matrix-pending" id="pn-ref-75L">Γùï</td><td id="pn-ref-75L-exp">-</td><td id="pn-ref-75L-dec">-</td></tr>
                            <tr><td>150S</td><td class="matrix-cell matrix-pending" id="pn-ref-150S">Γùï</td><td id="pn-ref-150S-exp">-</td><td id="pn-ref-150S-dec">-</td></tr>
                            <tr><td>150L</td><td class="matrix-cell matrix-pending" id="pn-ref-150L">Γùï</td><td id="pn-ref-150L-exp">-</td><td id="pn-ref-150L-dec">-</td></tr>
                            <tr><td>300S</td><td class="matrix-cell matrix-pending" id="pn-ref-300S">Γùï</td><td id="pn-ref-300S-exp">-</td><td id="pn-ref-300S-dec">-</td></tr>
                            <tr><td>300L</td><td class="matrix-cell matrix-pending" id="pn-ref-300L">Γùï</td><td id="pn-ref-300L-exp">-</td><td id="pn-ref-300L-dec">-</td></tr>
                            <tr><td>600S</td><td class="matrix-cell matrix-pending" id="pn-ref-600S">Γùï</td><td id="pn-ref-600S-exp">-</td><td id="pn-ref-600S-dec">-</td></tr>
                            <tr><td>600L</td><td class="matrix-cell matrix-pending" id="pn-ref-600L">Γùï</td><td id="pn-ref-600L-exp">-</td><td id="pn-ref-600L-dec">-</td></tr>
                            <tr><td>1200S</td><td class="matrix-cell matrix-pending" id="pn-ref-1200S">Γùï</td><td id="pn-ref-1200S-exp">-</td><td id="pn-ref-1200S-dec">-</td></tr>
                            <tr><td>1200L</td><td class="matrix-cell matrix-pending" id="pn-ref-1200L">Γùï</td><td id="pn-ref-1200L-exp">-</td><td id="pn-ref-1200L-dec">-</td></tr>
                            <tr><td>2400S</td><td class="matrix-cell matrix-pending" id="pn-ref-2400S">Γùï</td><td id="pn-ref-2400S-exp">-</td><td id="pn-ref-2400S-dec">-</td></tr>
                            <tr><td>2400L</td><td class="matrix-cell matrix-pending" id="pn-ref-2400L">Γùï</td><td id="pn-ref-2400L-exp">-</td><td id="pn-ref-2400L-dec">-</td></tr>
                        </tbody>
                    </table>
                </div>
    ...
    <script>
        ...
        async function runMelpeVocoder() {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    statusDiv.textContent = 'Γ£ô Vocoder complete! ' + result.message;
                    ...
                    statusDiv.textContent = 'Γ£ù Error: ' + result.message;
                }
            } catch (err) {
                statusDiv.className = 'melpe-status error';
                statusDiv.textContent = 'Γ£ù Error: ' + err.message;
            } finally {
                btn.disabled = false;
            }
        }
        ...
        async function toggleRecording() {
            ...
            if (mediaRecorder && mediaRecorder.state === 'recording') {
                // Stop recording
                mediaRecorder.stop();
                btn.innerHTML = '≡ƒÄñ Start Recording';
                ...
                try {
                    ...
                    btn.innerHTML = 'ΓÅ╣ Stop Recording';
        ...
        async function saveRecording() {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    option.textContent = '≡ƒÄñ ' + baseName + ' (' + (recordedPcmData.length / 8000).toFixed(1) + 's)';
        ...
        async function loadCustomRecordings() {
            try {
                ...
                if (result.recordings && result.recordings.length > 0) {
                    ...
                    separator.textContent = 'ΓöÇΓöÇ Your Recordings ΓöÇΓöÇ';
                    ...
                    result.recordings.forEach(rec => {
                        ...
                        option.textContent = '≡ƒÄñ ' + rec.name + ' (' + rec.duration + 's)';
                        select.appendChild(option);
                    });
                }
            } catch (err) {
        ...
        function updateTestStep(testId, stepIndex, status) {
            ...
            if (stepIndex < steps.length) {
                ...
                if (status === 'pending') icon.textContent = 'Γùï';
                else if (status === 'running') icon.textContent = 'ΓùÅ';
                else if (status === 'complete') icon.textContent = 'Γ£ô';
                else if (status === 'error') icon.textContent = 'Γ£ù';
            }
        }
        ...
        async function runInteropTest1() {
            ...
            interopLog('Starting Test 1: MS-DMT TX ΓåÆ PhoenixNest RX, Mode: ' + mode, 'info');
        ...
        async function runInteropTest2() {
            ...
            interopLog('Starting Test 2: PhoenixNest TX ΓåÆ MS-DMT RX, Mode: ' + mode, 'info');
        ...
        function updateMatrixCell(mode, testNum, success) {
            ...
            if (cell) {
                ...
                cell.textContent = success ? 'Γ£ô' : 'Γ£ù';
            }
        }
        ...
        async function runFullMatrix() {
            ...
            for (const mode of modes) {
                ...
                try {
                    ...
                    interopLog(mode + ' MS-DMTΓåÆPN: ' + (result1.success ? 'PASS (' + result1.decoded + ' bytes)' : 'FAIL - ' + (result1.error || 'No data')), 
                ...
                try {
                    ...
                    interopLog(mode + ' PNΓåÆMS-DMT: ' + (result2.success ? 'PASS (' + result2.decoded + ' bytes)' : 'FAIL - ' + (result2.error || 'No data')), 
                    ...
                    interopLog(mode + ' PNΓåÆMS-DMT: ERROR - ' + err.message, 'error');
                }
                completed++;
                document.getElementById('matrix-progress').textContent = 'Progress: ' + completed + '/' + total;
            }
            ...
            interopLog('Full matrix test complete: MS-DMTΓåÆPN ' + msdmtToPnPass + '/12, PNΓåÆMS-DMT ' + pnToMsdmtPass + '/12', 'info');
            ...
            report += '| **MS-DMT TX ΓåÆ PhoenixNest RX** | ' + msdmtToPnPass + '/12 |\\n';
            report += '| **PhoenixNest TX ΓåÆ MS-DMT RX** | ' + pnToMsdmtPass + '/12 |\\n';
            report += '| **Total Passed** | ' + totalPass + ' |\\n';
            report += '| **Total Failed** | ' + (total - totalPass) + ' |\\n\\n';
            report += '---\\n\\n';
            
            report += '## Compatibility Matrix\\n\\n';
            report += '| Mode | MS-DMT ΓåÆ PN | PN ΓåÆ MS-DMT | Details |\\n';
            report += '|------|:-----------:|:-----------:|---------|\\n';
            for (const mode of modes) {
                const r1 = results.msdmtToPn[mode] || {};
                const r2 = results.pnToMsdmt[mode] || {};
                const s1 = r1.success ? 'Γ£à PASS' : 'Γ¥î FAIL';
                const s2 = r2.success ? 'Γ£à PASS' : 'Γ¥î FAIL';
                let details = '';
                if (!r1.success && r1.error) details += 'MS-DMTΓåÆPN: ' + r1.error + ' ';
                if (!r2.success && r2.error) details += 'PNΓåÆMS-DMT: ' + r2.error;
            ...
            report += '### MS-DMT TX ΓåÆ PhoenixNest RX\\n\\n';
        ...
        async function checkLicenseStatus() {
            ...
            statusDiv.innerHTML = '<h3>ΓÅ│ Checking License...</h3><p>Please wait...</p>';
            ...
            try {
                ...
                if (currentLicenseKey) {
                    ...
                    statusDiv.innerHTML = '<h3>ΓÜá∩╕Å Network Error</h3><p>' + err.message + '</p>' +
        ...
        function showLicenseValid(result) {
            ...
            statusDiv.innerHTML = '<h3>Γ£ô License Valid</h3><p>' + result.message + '</p>';
        ...
        function showLicenseInvalid(message) {
            ...
            statusDiv.className = 'license-status invalid';
            statusDiv.innerHTML = '<h3>Γ£ù License Invalid</h3><p>' + message + '</p>' +
        ...
        function showLicensePending() {
            ...
            statusDiv.innerHTML = '<h3>ΓÅ│ License Request Pending</h3>' +
        ...
        async function checkForLicense() {
            ...
            try {
                ...
                if (result.found && result.license_key) {
                    ...
                    msgDiv.innerHTML = 'Γ£ô License found and installed!';
                    ...
                    msgDiv.textContent = 'ΓÅ│ ' + result.message;
                } else {
                ...
                msgDiv.className = 'upload-status error';
                msgDiv.textContent = 'Γ£ù Error: ' + err.message;
            }
        }
        ...
        async function requestLicense() {
            ...
            if (!name || name.length < 2) {
                msgDiv.className = 'upload-status error';
                msgDiv.style.display = 'block';
                msgDiv.textContent = 'Γ£ù Please enter your full name';
                return;
            }
            if (!email || !email.includes('@')) {
                msgDiv.className = 'upload-status error';
                msgDiv.style.display = 'block';
                msgDiv.textContent = 'Γ£ù Please enter a valid email address';
                return;
            }
            ...
            try {
                ...
                if (result.success) {
                    if (result.status === 'already_licensed' && result.license_key) {
                        ...
                        msgDiv.className = 'upload-status success';
                        msgDiv.innerHTML = 'Γ£ô ' + result.message;
                    ...
                    msgDiv.className = 'upload-status error';
                    msgDiv.textContent = 'Γ£ù ' + (result.message || 'Request failed');
                }
            } catch (err) {
                msgDiv.className = 'upload-status error';
                msgDiv.textContent = 'Γ£ù Error: ' + err.message;
                ...
                btn.disabled = false;
                btn.textContent = '≡ƒôñ Submit License Request';
            }
        }
        ...
        async function uploadSingleReport(filename, btn) {
            ...
            try {
                ...
                if (result.success) {
                    showPopup('Γ£ô Uploaded as <a href="' + result.issue_url + 
                ...
                showPopup('Γ£ù Upload failed: ' + err.message, false);
                btn.innerHTML = 'Γ£ù';
        ...
        async function uploadReport() {
            ...
            try {
                ...
                if (result.success) {
                    ...
                    statusDiv.innerHTML = 'Γ£ô Report uploaded as <a href=\"' + result.issue_url + 
                ...
                statusDiv.textContent = 'Γ£ù ' + err.message;
            } finally {
                btn.disabled = false;
                btn.textContent = '≡ƒôè Upload Diagnostic Report';
            }
        }
...
private:
    ...
    void handle_msdmt_test1(SOCKET client, const std::string& path) {
        // Test 1: MS-DMT TX ΓåÆ PhoenixNest RX
    ...
    void handle_msdmt_test2(SOCKET client, const std::string& path) {
        // Test 2: PhoenixNest TX ΓåÆ MS-DMT RX
    ...
    void handle_msdmt_test1_quick(SOCKET client, const std::string& path) {
        // Quick version for matrix testing - MS-DMT TX ΓåÆ PhoenixNest RX
        std::string mode = "600S", message = "TEST", txdir = "./tx_pcm_out";
    ...
    void handle_msdmt_test2_quick(SOCKET client, const std::string& path) {
        // Quick version for matrix testing - PhoenixNest TX ΓåÆ MS-DMT RX
        std::string mode = "600S", message = "TEST";
