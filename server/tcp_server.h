...
/**
 * @file tcp_server.h
 * @brief TCP/IP Network Interface Server for M110A Modem
 * 
 * Implements the network protocol layer for MIL-STD-188-110A modem.
 * Originally developed for Brain Corp, now used for Phoenix Nest M110A.
 * 
 ...
 * 
 * Compatible with Brain Modem client applications.
 */
