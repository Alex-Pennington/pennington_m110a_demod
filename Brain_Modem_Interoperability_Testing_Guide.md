# Brain Modem TCP/IP Protocol for Interoperability Testing
...
â”‚  â”‚ TX/RX       â”‚  â”‚ Status msgs â”‚  â”‚ for auto-discovery  â”‚ â”‚
...
## Status Messages (Async from Brain Modem)
...
- **TX:** Send bytes â†’ `CMD:SENDBUFFER` triggers transmission
...
### Scenario 1: Brain Modem TX â†’ PhoenixNest RX (Validate Brain Modem TX)

```
â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”    PCM File    â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
â”‚   Brain Modem     â”‚ â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â†’ â”‚  PhoenixNest     â”‚
â”‚   (TX)       â”‚                â”‚  (RX/Decode)     â”‚
â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜                â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜
```

**Steps:**
```
# 1. Start Brain Modem: Brain Modem.exe --testdevices
# 2. Connect to ports 4998 and 4999

[CTRL] â†’ CMD:DATA RATE:600S
[CTRL] â† OK:DATA RATE:600S
[CTRL] â†’ CMD:RECORD TX:ON
[CTRL] â† OK:RECORD TX:ON
[CTRL] â†’ CMD:RECORD PREFIX:phoenix_test
[CTRL] â† OK:RECORD PREFIX:phoenix_test
[DATA] â†’ <binary test message>
[CTRL] â†’ CMD:SENDBUFFER
[CTRL] â† STATUS:TX:TRANSMIT
[CTRL] â† STATUS:TX:IDLE
...
### Scenario 2: PhoenixNest TX â†’ Brain Modem RX (Validate PhoenixNest TX)

```
â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”    PCM File    â”Œâ”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”
â”‚  PhoenixNest     â”‚ â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â†’ â”‚   Brain Modem     â”‚
â”‚  (TX/Generate)   â”‚                â”‚   (RX)       â”‚
â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜                â””â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”˜
```
...
# 2. Start Brain Modem: Brain Modem.exe --testdevices
# 3. Connect to ports 4998 and 4999

[CTRL] â† MODEM READY
[CTRL] â†’ CMD:RXAUDIOINJECT:C:\path\to\phoenix_tx.pcm
[CTRL] â† OK:RXAUDIOINJECT:STARTED:C:\path\to\phoenix_tx.pcm
[CTRL] â† STATUS:RX:600 BPS SHORT      # Mode detected!
[DATA] â† <decoded binary bytes>        # Data appears here
[CTRL] â† STATUS:RX:NO DCD             # End of signal
[CTRL] â† OK:RXAUDIOINJECT:COMPLETE:105600 samples

# 4. Compare decoded data to original message
```

### Scenario 3: Full Loopback via PCM (Brain Modem TX â†’ Brain Modem RX)

**Brain Modem doesn't have internal loopback**, but you can achieve the same result:

```
TX â†’ Record PCM â†’ Inject PCM â†’ RX â†’ Compare
```
...
[CTRL] â†’ CMD:DATA RATE:600S
[CTRL] â†’ CMD:RECORD TX:ON
[CTRL] â†’ CMD:RECORD PREFIX:loopback_test
[DATA] â†’ HELLO WORLD
[CTRL] â†’ CMD:SENDBUFFER
[CTRL] â† STATUS:TX:IDLE

# 2. Inject the recorded file back into RX
[CTRL] â†’ CMD:RXAUDIOINJECT:./tx_pcm_out/loopback_test_*.pcm
[CTRL] â† STATUS:RX:600 BPS SHORT
[DATA] â† HELLO WORLD
[CTRL] â† STATUS:RX:NO DCD
...
for mode in modes:
    # Test 1: Brain Modem TX â†’ PhoenixNest RX
    ...
    # Test 2: PhoenixNest TX â†’ Brain Modem RX  
